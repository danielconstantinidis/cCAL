...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <title>cCAL/README.md at master · danielconstantinidis/cCAL · GitHub</title>
...
<meta content="oTFJLhzuecytT1XfqW5xyUpvPECnpOEtV5+P+U2/8mE=" name="csrf-token" />
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button" href="/login?return_to=%2Fdanielconstantinidis%2FcCAL%2Fblob%2Fmaster%2FREADME.md">Sign in</a>
    </div>
...
<ul class="pagehead-actions">
    ...
    <li>
      <a href="/login?return_to=%2Fdanielconstantinidis%2FcCAL"
        class="minibutton with-count js-toggler-target star-button entice tooltipped upwards"
        title="You must be signed in to use this feature" rel="nofollow">
        <span class="octicon octicon-star"></span>Star
      </a>
      <a class="social-count js-social-count" href="/danielconstantinidis/cCAL/stargazers">
        0
      </a>
    </li>
    <li>
      ...
      <a href="/danielconstantinidis/cCAL/network" class="social-count">
        0
      </a>
    </li>
</ul>
              ...
              <h1 itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="entry-title public">
                ...
                <span class="author vcard">
                  <a href="/danielconstantinidis" class="url fn" itemprop="url" rel="author">
                  <span itemprop="title">danielconstantinidis</span>
                  </a></span> /
                <strong><a href="/danielconstantinidis/cCAL" class="js-current-repository">cCAL</a></strong>
              </h1>
            </div>

            
  <ul class="tabs">
    <li class="pulse-nav"><a href="/danielconstantinidis/cCAL/pulse" class="js-selected-navigation-item " data-selected-links="pulse /danielconstantinidis/cCAL/pulse" rel="nofollow"><span class="octicon octicon-pulse"></span></a></li>
    <li><a href="/danielconstantinidis/cCAL" class="js-selected-navigation-item selected" data-selected-links="repo_source repo_downloads repo_commits repo_tags repo_branches /danielconstantinidis/cCAL">Code</a></li>
    <li><a href="/danielconstantinidis/cCAL/network" class="js-selected-navigation-item " data-selected-links="repo_network /danielconstantinidis/cCAL/network">Network</a></li>
    <li><a href="/danielconstantinidis/cCAL/pulls" class="js-selected-navigation-item " data-selected-links="repo_pulls /danielconstantinidis/cCAL/pulls">Pull Requests <span class='counter'>0</span></a></li>

      <li><a href="/danielconstantinidis/cCAL/issues" class="js-selected-navigation-item " data-selected-links="repo_issues /danielconstantinidis/cCAL/issues">Issues <span class='counter'>0</span></a></li>



    <li><a href="/danielconstantinidis/cCAL/graphs" class="js-selected-navigation-item " data-selected-links="repo_graphs repo_contributors /danielconstantinidis/cCAL/graphs">Graphs</a></li>
...
<div class="tabnav">
  ...
  <span class="tabnav-right">
    <ul class="tabnav-tabs">
          <li><a href="/danielconstantinidis/cCAL/tags" class="js-selected-navigation-item tabnav-tab" data-selected-links="repo_tags /danielconstantinidis/cCAL/tags">Tags <span class="counter blank">0</span></a></li>
    </ul>
  </span>
        ...
        <div class="select-menu-modal">
          ...
          <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket css-truncate" data-tab-filter="branches">
            ...
            <div data-filterable-for="commitish-filter-field" data-filterable-type="substring">
                ...
                <div class="select-menu-item js-navigation-item selected">
                  <span class="select-menu-item-icon octicon octicon-check"></span>
                  <a href="/danielconstantinidis/cCAL/blob/master/README.md" class="js-navigation-open select-menu-item-text js-select-button-text css-truncate-target" data-name="master" rel="nofollow" title="master">master</a>
                </div> <!-- /.select-menu-item -->
            </div>
  ...
  <ul class="tabnav-tabs">
    <li><a href="/danielconstantinidis/cCAL" class="selected js-selected-navigation-item tabnav-tab" data-selected-links="repo_source /danielconstantinidis/cCAL">Files</a></li>
    <li><a href="/danielconstantinidis/cCAL/commits/master" class="js-selected-navigation-item tabnav-tab" data-selected-links="repo_commits /danielconstantinidis/cCAL/commits/master">Commits</a></li>
    <li><a href="/danielconstantinidis/cCAL/branches" class="js-selected-navigation-item tabnav-tab" data-selected-links="repo_branches /danielconstantinidis/cCAL/branches" rel="nofollow">Branches <span class="counter ">1</span></a></li>
  </ul>
    ...
    <div class="frame-meta">
      ...
      <p title="This is a placeholder element" class="js-history-link-replace hidden"></p>
        ...
        <div class="breadcrumb">
          <span class='bold'><span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb"><a href="/danielconstantinidis/cCAL" class="js-slide-to" data-branch="master" data-direction="back" itemscope="url"><span itemprop="title">cCAL</span></a></span></span><span class="separator"> / </span><strong class="final-path">README.md</strong> <span class="js-zeroclipboard zeroclipboard-button" data-clipboard-text="README.md" data-copied-hint="copied!" title="copy to clipboard"><span class="octicon octicon-clippy"></span></span>
        </div>

      <a href="/danielconstantinidis/cCAL/find/master" class="js-slide-to" data-hotkey="t" style="display:none">Show File Finder</a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list">
        <li class="facebox-user-list-item">
          <img height="24" src="https://secure.gravatar.com/avatar/b736588d64cbf15e02232c8a7448965e?s=140&amp;d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-user-420.png" width="24" />
          <a href="/danielconstantinidis">danielconstantinidis</a>
        </li>
      </ul>
    </div>
  </div>
            ...
            <div class="meta">
              ...
              <div class="actions">
                <div class="button-group">
                  ...
                  <a href="/danielconstantinidis/cCAL/raw/master/README.md" class="button minibutton " id="raw-url">Raw</a>
                    <a href="/danielconstantinidis/cCAL/blame/master/README.md" class="button minibutton ">Blame</a>
                  <a href="/danielconstantinidis/cCAL/commits/master/README.md" class="button minibutton " rel="nofollow">History</a>
                </div><!-- /.button-group -->
              </div><!-- /.actions -->
      ...
      <textarea name="fullscreen-contents" id="fullscreen-contents" class="js-fullscreen-contents" placeholder="" data-suggester="fullscreen_suggester"></textarea>
          <div class="suggester-container">
              <div class="suggester fullscreen-suggester js-navigation-container" id="fullscreen_suggester"
                 data-url="/danielconstantinidis/cCAL/suggestions/commit">
              </div>
          </div>
    </div>
  </div>
